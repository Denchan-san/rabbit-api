...
namespace Rabbit_API.Migrations
{
    ...
    [Migration("20240905162127_DroppingLocalUserAndChangingReferencesToApplicationUser")]
    partial class DroppingLocalUserAndChangingReferencesToApplicationUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Rabbit_API.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Rabbit_API.Models.Post", b =>
                {
                    ...
                    b.HasOne("Rabbit_API.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
